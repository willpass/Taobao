...
public class UpdateManager {
	...
	private static final String PATH = "http://www.51sexsex.com/mobile/app/version.json";
	...
	protected boolean isUpdate() {
		...
		try {
			localVersion = mContext.getPackageManager().getPackageInfo("com.sexiansheng.taobao", 0).versionCode;
